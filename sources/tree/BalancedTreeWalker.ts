...
export class BalancedTreeWalker<Element>
{
  ...
  */
  ...
  /**
  * @returns True if this walker does not visit a tree.
  */
  ...
  /**
  * @returns True if this walker is visiting a tree.
  */
  ...
  /**
  * @returns The tree that is visited by this walker if any.
  */
  ...
  /**
  * @returns The location of this walker as an array of index.
  */
  ...
  */
  ...
  /**
  * @returns True if the current element is a leaf.
  */
  ...
  /**
  * @returns True if the current element is a node.
  */
  ...
  /**
  * @returns True if the current element is the root element of the tree.
  */
  ...
  */
  ...
  /**
  * @returns True if there is another key next to the current one.
  */
  ...
  */
  ...
  /**
  * @returns True if there is another key previous to the current one.
  */
  ...
  */
  ...
  /**
  * @returns True if this walker can enter into another children.
  */
  ...
  */
  ...
  /**
  * @returns The current key index selected by this tree walker.
  */
  ...
  /**
  * @returns The number of keys into the current element.
  */
  ...
  * @param element - Element to search.
  *
  * @returns The index of the given element into the current node.
  */
