...
export class BalancedTreeNode<Element> extends BalancedTreeElement<Element> {
  ...
  */
  ...
  /**
  * @returns A view over each child element of this element.
  */
  ...
  *
  * @returns The index of the child that must contains the given element.
  */
  ...
  * @param element - An element to search.
  *
  * @returns The child that must contains the given element.
  */
  ...
  *
  * @returns The new node, result of the split.
  */
