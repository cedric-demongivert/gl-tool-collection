...
export class BalancedTreeElement<Element> {
  ...
  */
  ...
  /**
  * @returns True if this balanced tree element can't hold more elements.
  */
  ...
  /**
  * @returns A view over each keys into this element.
  */
  ...
  /**
  * @returns The ascending order of this tree element.
  */
  ...
  /**
  * @returns The descending order of this tree element.
  */
  ...
  */
  ...
  /**
  * @returns The parent element of this element if exists.
  */
  ...
  *
  * @returns True if this element contains the given key.
  */
  ...
  * @param key - A key to search.
  *
  * @returns The index of the given key into this element if exists.
  */
