...
export class FactoryAllocator<T extends Clearable & Copiable<T>> implements Allocator<T> {
  /**
...
export namespace FactoryAllocator {
  export function create<T extends Clearable & Copiable<T>>(factory: Factory<T>, capacity: number = 16): FactoryAllocator<T> {
