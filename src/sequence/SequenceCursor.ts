...
export class SequenceCursor<Element> implements RandomAccessCursor<Element>
{
   ...
   * 
   */
  public copy(toCopy: SequenceIndexCursor<Element>): void {
   ...
   */
  public clone(): SequenceIndexCursor<Element> {
    return new SequenceIndexCursor<Element>(this.sequence, this.index)
  }
